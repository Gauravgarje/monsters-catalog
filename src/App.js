...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1 className="app-title">Robo Monsters Catalog</h1>
        <SearchBox className='monsters-search-box' onChangeHandler={onSearchChange} placeHolder='Search robot monsters' />
        <CardList monsters={filteredMonsters} />
        <h3 className='app-footer'>ⓒGaurav Garje | All rights reserved</h3>
      </div>
    );
  }
}
